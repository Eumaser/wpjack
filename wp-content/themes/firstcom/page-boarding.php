<?php /* Template Name: Page - Boarding */ ?>
<?php get_header();
  $page_id  = get_page_by_title('Boarding')->ID;
...
<?php $banner_image = get_field('banner_image', 170); ?>
<?php $background_image = get_field('background_image', 170); ?>
<?php $sidebar_repeater = get_field('sidebar_repeater','options'); ?>


<?php
  $query = new WP_Query(array(
    'post_type'   => 'boarding_house',
    'post_status'   => 'publish',
    'orderby'     => 'ID',
    'order'     => 'ASC'
    )
...
<?php $banner_title = get_field('banner_title', 170); ?>
<?php $banner_description = get_field('banner_description', 170); ?>
<?php $page_title = get_field('page_title', 170); ?>
